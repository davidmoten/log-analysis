...
<ul>
	<li><a
		href="graph.html?buckets=0&finish=now&interval=1h&metric=MAX&extraMetric=MAX&field1=specialNumber&table=Dummy&width=1000px&height=500px&title1=Demonstration - non-aggregated">Last
			hour, all points</a></li>
	<li><a
		href="graph.html?buckets=60&finish=now&interval=1m&metric=MAX&extraMetric=MAX&field1=specialNumber&table=Dummy&width=1000px&height=500px&title1=Demonstration - maximum aggregated by minute for the last hour">Last
